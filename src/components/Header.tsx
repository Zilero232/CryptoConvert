...
import { setPrefix } from '../redux/languages/slice'
          ...
          <div className="header__wrapper">
            ...
            <nav className="header__navigation navigation">
              <ul className="navigation__list">
                {translate[prefix].map((item: any, idx: number) => {
                  return (
            ...
            <div className="header__user-nav header-user-nav">
              ...
              >
                <img className="header-user-nav-btn__img" src={require(`../assets/images/flag-${prefix}.png`)} alt="flag" />
                <img
                ...
                {isOpenLanguage && (
                  <ul className="header-user-nav-btn__list">
                    <li onClick={() => dispatch(setPrefix("ru"))} className="header-user-nav-btn__list-item">
                      <p className="header-user-nav-btn__list-text">Ru</p>
                    </li>
                    <li onClick={() => dispatch(setPrefix("en"))} className="header-user-nav-btn__list-item">
